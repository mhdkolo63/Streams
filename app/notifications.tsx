...
import Animated, { FadeIn, FadeInDown, FadeInUp, FadeOut, Layout, SlideOutRight } from 'react-native-reanimated';
    ...
    >
      ...
      >
        ...
        <View style={styles.notificationContent}>
          <Text style={styles.notificationTitle} numberOfLines={2}>{item.title || 'New video uploaded'}</Text>
      ...
      <View style={styles.container}>
        ...
        {!user ? (
          ...
          <EmptyState
            ...
            message={filter === 'unread' ? "You've read all your notifications!" : "We'll notify you when new videos are uploaded."}
          />
        ) : (
          <FlatList
            data={notifications}
...
const styles = StyleSheet.create({
  ...
  filterTabText: { fontSize: FontSizes.md, color: Colors.text.secondary, fontWeight: FontWeights.medium },
  filterTabTextActive: { color: Colors.primary },
  filterBadge: { backgroundColor: Colors.status.success, paddingHorizontal: Spacing.xs, paddingVertical: 1, borderRadius: BorderRadius.full, minWidth: 18, alignItems: 'center' },
  filterBadgeText: { fontSize: 10, fontWeight: FontWeights.bold, color: Colors.text.primary },
  ...
  thumbnail: { width: 80, height: 60, borderRadius: BorderRadius.md },
  thumbnailPlaceholder: { width: 80, height: 60, borderRadius: BorderRadius.md, backgroundColor: Colors.tertiary, justifyContent: 'center', alignItems: 'center' },
  unreadDot: { position: 'absolute', top: 4, right: 4, width: 10, height: 10, borderRadius: 5, backgroundColor: Colors.primary, borderWidth: 2, borderColor: Colors.background },
  ...
  skeletonThumbnail: { width: 80, height: 60, borderRadius: BorderRadius.md, backgroundColor: Colors.tertiary },
